...
# Created by write_sdc on Sun Jul 6 23:28:27 2025
...
set_driving_cell -lib_cell SAEDRVT14_BUF_4 -pin X [get_ports test_mode]
set_driving_cell -lib_cell SAEDRVT14_BUF_4 -pin X [get_ports SE]
set_driving_cell -lib_cell SAEDRVT14_BUF_4 -pin X [get_ports {SI[4]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_4 -pin X [get_ports {SI[3]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_4 -pin X [get_ports {SI[2]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_4 -pin X [get_ports {SI[1]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_4 -pin X [get_ports {SI[0]}]
...
set_clock_uncertainty 10  [get_clocks scan_clk]
